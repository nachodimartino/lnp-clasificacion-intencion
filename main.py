...
class MensajeInput(BaseModel):
    ...
    model_config = {"json_schema_extra": {"examples": [
        {"texto": "hola buenas, me pasas info del depa de 3 ambientes?"},
        {"texto": "quiero señar ese departamento, cómo hago?"},
        {"texto": "ya no me interesa, conseguí algo por otro lado"},
    ]}}
